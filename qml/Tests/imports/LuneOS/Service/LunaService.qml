...
QtObject {
    ...
    function listLaunchPoints_call(jsonArgs, returnFct, handleError) {
        returnFct({"payload": JSON.stringify({"returnValue": true,
                    "launchPoints": [
             { "title": "Calendar", "id": "org.webosports.tests.dummyWindow", "icon": "../images/default-app-icon.png", "launcherTab": "Apps" },
             { "title": "Email", "id": "org.webosports.tests.dummyWindow", "icon": "../images/default-app-icon.png", "launcherTab": "Apps" },
             { "title": "Calculator", "id": "org.webosports.tests.dummyWindow", "icon": "../images/default-app-icon.png", "launcherTab": "Apps", "showInSearch": false },
             { "title": "Snowshoe", "id": "org.webosports.tests.dummyWindow", "icon": "../images/default-app-icon.png", "launcherTab": "Settings" },
             { "title": "This is a long title", "id": "org.webosports.tests.dummyWindow", "icon": "../images/default-app-icon.png", "launcherTab": "Settings" },
             { "title": "This_is_also_a_long_title", "id": "org.webosports.tests.dummyWindow", "icon": "../images/default-app-icon.png", "launcherTab": "Apps" },
             { "title": "Preware 5", "id": "org.webosports.tests.dummyWindow", "icon": "../images/default-app-icon.png", "launcherTab": "Downloads" },
             { "title": "iOS", "id": "org.webosports.tests.dummyWindow", "icon": "../images/default-app-icon.png", "launcherTab": "Apps" },
             { "title": "Test2", "id": "org.webosports.tests.dummyWindow", "icon": "../images/default-app-icon.png", "launcherTab": "Apps" },
             { "title": "DummyWindow", "id": "org.webosports.tests.dummyWindow", "icon": "../images/default-app-icon.png", "launcherTab": "Apps" },
             { "title": "DummyWindow2", "id": "org.webosports.tests.dummyWindow2", "icon": "../images/default-app-icon.png", "launcherTab": "Apps" },
             { "title": "DashboardWindow", "id": "org.webosports.tests.fakeDashboardWindow", "icon": "../images/default-app-icon.png", "launcherTab": "Apps" },
             { "title": "SIMPinWindow", "id": "org.webosports.tests.fakeSimPinWindow", "icon": "../images/default-app-icon.png", "launcherTab": "Apps" },
             { "title": "Oh My", "id": "org.webosports.tests.dummyWindow", "icon": "../images/default-app-icon.png", "launcherTab": "Apps" },
             { "title": "Test1", "id": "org.webosports.tests.dummyWindow", "icon": "../images/default-app-icon.png", "launcherTab": "Downloads" },
             { "title": "Test No Tab", "id": "org.webosports.tests.dummyWindow", "icon": "../images/default-app-icon.png" },
             { "title": "Test3", "id": "org.webosports.tests.dummyWindow", "icon": "../images/default-app-icon.png", "launcherTab": "Apps" },
             { "title": "Test5", "id": "org.webosports.tests.dummyWindow", "icon": "../images/default-app-icon.png", "launcherTab": "Favorites" },
             { "title": "Test5bis", "id": "org.webosports.tests.dummyWindow", "icon": "../images/default-app-icon.png", "launcherTab": "Apps" },
             { "title": "Test6", "id": "org.webosports.tests.dummyWindow", "icon": "../images/default-app-icon.png", "launcherTab": "Favorites" },
             { "title": "End Of All Tests", "id": "org.webosports.tests.dummyWindow", "icon": "../images/default-app-icon.png", "launcherTab": "Favorites" }
           ]})});
    }

...
Item {
    ...
    property real appIconHMargin: calculateAppIconHMargin(fullLauncher,
                                                          appIconWidth)

    property real cellWidth: appIconWidth + appIconHMargin
    property real cellHeight: iconSize + Units.gu(1.4) * 2 + Units.gu(
                                  3) // we give margin for two lines of text
    ...
    ListView {
        ...
        delegate: Button {
            ...
            style: ButtonStyle {
                id: tabButtonStyle
                property string neutralButtonImage: Qt.resolvedUrl(
                                                        "../images/launcher/tab-bg.png")
                property string neutralButtonImagePressed: Qt.resolvedUrl(
                                                               "../images/launcher/tab-selected-bg.png")
                property string neutralButtonImageHighlight: Qt.resolvedUrl(
                                                                 "../images/launcher/tab-highlight.png")
            ...
            text: tabTitleCaseTweak.value
                  === "upperCase" ? model.text.toString().toUpperCase(
                                        ) : tabTitleCaseTweak.value
                                    === "lowerCase" ? model.text.toString(
                                                          ).toLowerCase(
                                                          ) : model.text
            ...
            function getArrowVisible(arrowDirection) {
                ...
                if (tabIndicatorArrowsTweak.value) {
                    console.log("Herrie tabIndicatorArrowsTweak.value: "
                                + tabIndicatorArrowsTweak.value)
                    if (tabIndicatorNumberTweak.value === "default") {
                        if (Screen.width > Screen.height) {
            ...
            Image {
                ...
                visible: getArrowVisible(
                             "left") //(!tabIndicatorNumberTweak.value==="all" /*|| (tabIndicatorNumberTweak.value==="default" && Screen.width > Screen.heigth)*/) && index + 1 > 1 && tabIndicatorArrowsTweak.value === "true"
                smooth: true
                MouseArea {
                    anchors.fill: parent
                    onClicked: {
    ...
    Button {
        ...
        anchors.right: tabRowList.right
        anchors.rightMargin: 8
        anchors.verticalCenter: tabRowList.verticalCenter
        visible: fullLauncher.isEditionActive
                 && !draggedLauncherIcon.draggingActive
        style: ButtonStyle {
            id: tabFooterButtonStyle
            property string doneButtonImage: Qt.resolvedUrl(
                                                 "../images/launcher/edit-button-done.png")
            property string doneButtonImagePressed: Qt.resolvedUrl(
                                                        "../images/launcher/edit-button-done-pressed.png")
    ...
    DropArea {
        ...
        onEntered: {
            ...
            var dragPosition = tabRowList.indexAt(
                        coordsDragInTabRowList.x + tabRowList.contentX, 0)
            if (dragPosition >= 0) {
    ...
    ListView {
        ...
        delegate: Item {
            ...
            GridView {
                ...
                width: Math.floor(
                           fullLauncher.width / fullLauncher.cellWidth) * fullLauncher.cellWidth
                ...
                model: TabApplicationModel {
                    ...
                    isDefaultTab: tabContentItem.tabId
                                  === "Apps" // apps without any tab indication go to the Apps tab
                }
                ...
                delegate: DraggableAppIcon {
                    ...
                    onStartLaunchApplication: if (!fullLauncher.isEditionActive)
                                                  fullLauncher.startLaunchApplication(
                                                              appId, appParams)
                }
                ...
                Connections {
                    target: fullLauncher
                    onIsEditionActiveChanged: if (!fullLauncher.isEditionActive)
                ...
                function saveCurrentLayout() {
                    ...
                    __queryDB("del", {
                                  query: {
                                      from: "org.webosports.lunalaunchertab:1",
                                      where: [{
                                              prop: "tab",
                                              op: "=",
                                              val: tabContentItem.tabId
                                          }]
                                  }
                              }, function (message) {})
                    ...
                    for (var i = 0; i < gridTabModel.count; ++i) {
                        ...
                        data.push({
                                      _kind: "org.webosports.lunalaunchertab:1",
                                      pos: i,
                ...
                DropArea {
                    ...
                    Image {
                        ...
                        source: Qt.resolvedUrl(
                                    "../images/launcher/scroll-tab-left.png")
                    }
                }
                DropArea {
                    ...
                    Image {
                        ...
                        fillMode: Image.TileVertically
                        source: Qt.resolvedUrl(
                                    "../images/launcher/scroll-tab-right.png")
                    }
                }
                DropArea {
                    ...
                    onEntered: {
                        // Find what index the drag is covering
                        var coordsDragInGridView = mapToItem(
                                    fullLauncherGridView, drag.x, drag.y)
                        placeHolderPosition = fullLauncherGridView.indexAt(
                                    coordsDragInGridView.x,
                                    coordsDragInGridView.y + fullLauncherGridView.contentY)
                        ...
                        gridTabModel.insert(placeHolderPosition, {
                                                title: "",
                                                icon: "",
                                                id: "",
                                                params: ""
                    ...
                    onPositionChanged: {
                        ...
                        var coordsDragInGridView = mapToItem(
                                    fullLauncherGridView, drag.x, drag.y)
                        var destPlaceHolderPosition = fullLauncherGridView.indexAt(
                                    coordsDragInGridView.x,
                                    coordsDragInGridView.y + fullLauncherGridView.contentY)
                        if (destPlaceHolderPosition >= 0
                                && destPlaceHolderPosition < gridTabModel.count
                                && placeHolderPosition !== destPlaceHolderPosition) {
                            gridTabModel.move(placeHolderPosition,
                                              destPlaceHolderPosition, 1)
                            placeHolderPosition = destPlaceHolderPosition
                        }
                    }
                    onExited: {
        ...
        MouseArea {
            ...
            onPressed: {
                if (fullLauncher.isEditionActive && !held) {
                    ...
                    var coordsDragInGridView = mapToItem(currentGridView,
                                                         mouse.x, mouse.y)
                    var targetItem = currentGridView.itemAt(
                                coordsDragInGridView.x,
                                coordsDragInGridView.y + currentGridView.contentY)

                    if (targetItem) {
                        draggedLauncherIcon.initiateDragWithItem(
                                    targetItem, targetItem.x,
                                    targetItem.y - currentGridView.contentY)
                        held = true
            ...
            onReleased: {
                if (held && !releaseHeld.running) {
                    ...
                    if (draggedLauncherIcon.Drag.target
                            && (typeof draggedLauncherIcon.Drag.target.placeHolderPosition
                                !== "undefined")) {
                        draggedLauncherIcon.Drag.drop()
                    } else {
                        console.log("no drop target, resetting drag source")
                        currentGridView.model.insert(
                                    draggedLauncherIcon.modelIndex, {
    ...
    function __queryDB(action, params, handleResultFct) {
        lunaNextLS2Service.call("luna://com.palm.db/" + action,
                                JSON.stringify(params), handleResultFct,
                                __handleDBError)
    }
}
}
